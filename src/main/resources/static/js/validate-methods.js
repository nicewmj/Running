...
$(function () {
    ...
    jQuery.validator.addMethod("isMobile", function (value, element) {
        ...
        // return this.optional(element) || (length == 11 && /^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(17[0,3,5-8])|(18[0-9])|166|198|199|(147))+\d{8}$/.test(value));
        return this.optional(element) || (length == 11 && /^((13[0-9])|(14[5,7])|(15[0-3,5-9])|(17[0,3,5-8])|(18[0-9])|166|(19[0-9])|(147))+\d{8}$/.test(value));
    }, "手机号码格式不正确。");
    ...
    jQuery.validator.addMethod("minNumber", function (value, element) {
        value = parseFloat(value);
        if (!(this.optional(element) || value >= 0)) {
            return false;
        }
    ...
    jQuery.validator.addMethod("newPwd", function (value, element, params) {
        var newPwd = /^.*(?=.{8,20})(?=.*\d)(?=.*[A-Z])(?=.*[a-z])(?=.*[!@#$%*+_=?.]).*$/;
        return this.optional(element) || (newPwd.test(value));
    }, "密码必须由大小写字母+数字+特殊符号!@#$%*+_=?.组成");
